...
fig, (ax1,ax2) = plt.subplots(2,1,sharex=True,gridspec_kw={'height_ratios': [3.3-2.4, .55+0.1]})
...
ax2.set_xticks(np.arange(3, 21, step=1))
...
plt.savefig('M-ds-ds.pdf', dpi=1200,bbox_inches='tight')