...
print(end-start) 
n0,n1,pid,n0Chunks,n1Chunks,dataH13,rand,Stack,bins,StackRad,binss,Stackhaloes,StackSep,binsSep,binsMR,StackMR,StackValues,FilHaloes,SepTotal,MRTotal,select= load(500)
