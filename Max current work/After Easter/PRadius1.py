...
XYZ = data.iloc[:,1:4]
bins = 100 
select = 100  #2938 max                                                                                            #set the number of bins in the histogram                                                                           #create an array to contain the stacking of non-physical pairs
i=0
...
for i in rand:    
    ...
    if ran == 0:
        cluster1,cluster2 = int(Ppairs[i]), int(Ppairs[i+1])  
    else: 
        cluster2,cluster1 = int(Ppairs[i]), int(Ppairs[i+1])
