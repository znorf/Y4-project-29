...
def Final():
    ...
    np.savetxt("midss_stackrad.csv", midss, delimiter=",")
    ...
    plt.ylabel('Total Filament Mass/solar masses')
    plt.xlim(3,20)
    np.savetxt("midss_ds.csv", midss, delimiter=",")
    np.savetxt("x_val_ds.csv", x_val, delimiter=",")
    np.savetxt("x_count_ds.csv", x_count, delimiter=",")
    np.savetxt("errors_x_ds.csv", errors_x, delimiter=",")
    np.savetxt("errors_y_ds.csv", errors_y, delimiter=",")
    ...
    np.savetxt("midss_MR.csv", midss, delimiter=",")
    np.savetxt("x_val_MR.csv", x_val, delimiter=",")
    np.savetxt("x_count_MR.csv", x_count, delimiter=",")
    np.savetxt("errors_x_MR.csv", errors_x, delimiter=",")
    np.savetxt("errors_y_MR.csv", errors_y, delimiter=",")
